...
export const projects = [
    {
        ...
        title: "Upload File",
        description:
            "This is a website for uploading all types of file. It is made using NextJS, Clerk, TailwindCSS and Firebase.Authenticated users can upload files and view their files. They can also delete their files, and rename them.",
    ...
    },
    {
        ...
        description:
            "This is a clone of BrightLine website. Its a webiste of a company that provides mental health services. This website is made using HTML, CSS and Javascript.",
    ...
    },
    {
        ...
        description:
            "This is a clone of Headphone Zone website. Its a webiste of a company that sells headphones. This website is made using HTML, CSS and Javascript.",
        type: projectType.Individual,
        techStack: ["HTML", "CSS", "Javascript"],
        allTechStack: ["HTML", "CSS", "Javascript"],
    ...
    },
    {
        ...
        description:
            "This is a SpringBoot REST API for a Vegetable Store. It has all the CRUD operations. It is made using SpringBoot, MySQL, Hibernate, JPA, Swagger and Lombok.",
        type: projectType.Group,
    ...
    },
    {
        ...
        description:
            "This is a SpringBoot REST API for Covid Vaccination. It has all the CRUD operations. It is made using SpringBoot, MySQL, Hibernate, JPA, Swagger and Lombok.",
        type: projectType.Group,
        techStack: ["Java", "SpringBoot", "MySQL"],
        allTechStack: [
            "Java",
    ...
    },
    {
        ...
        title: "Safar Sathi",
        description:
            "This is a Next.js 14 web app for managing the chaos of the logistics industry. It is made using NextJS, TailwindCSS, ShadcnUI",
        type: projectType.Individual,
        techStack: ["NextJS", "TailwindCSS", "ShadcnUI"],
        allTechStack: ["NextJS", "TailwindCSS", "ShadcnUI"],
